...
1b. Startup Android studio, open project "oasis2" and let a gradle build proceed.
...
This will bring up a client app. oasis.skeleton contains examples on how to build apps with SODAs (also known as QMs), and how to play with SmartThings.
